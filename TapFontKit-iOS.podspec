#
#  Be sure to run `pod spec lint TapFontKit-iOS.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "A private usage kit to ease loading localized fonts throughout different Tap Kits. It does the registering, mapping, loading and localizing the fonts based on the language identifier passed."

  spec.homepage     = "https://github.com/Tap-Payments/TapFontKit-iOS"
  ...
  spec.source       = { :git => "https://github.com/Tap-Payments/TapFontKit-iOS.git", :tag => "#{spec.version}" }
